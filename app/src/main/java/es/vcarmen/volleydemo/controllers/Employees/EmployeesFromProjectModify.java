 ...
 */
public class EmployeesFromProjectModify extends AppCompatActivity{
        ...
        StringRequest stringRequest = new StringRequest(
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        String employeeTask = null;
                        int index = 0;

                        for(Employee employee : listEmployees){
                            listSpinner.add(employee.getNameEmployee() + " " + employee.getSurnameEmployee());
                            String[] array = getIntent().getStringExtra("data").split(" ");
                            employeeName = array[0] + " " + array [1];
                            employeeSurname = array [2];
                            projectDate = array [3];
                            employeeTask = array [4];

                            if(employee.getNameEmployee().equals(employeeName) && employee.getSurnameEmployee().equals(employeeSurname))
                                    index = listEmployees.indexOf(employee);
                        }
                        ...
                        date.setText(projectDate);
                        task.setText(employeeTask);
                    }
                },
                new Response.ErrorListener() {
                    @Override
